...
<head>
  ...
  <title>CharityHub - Contact Us</title>
  ...
  <main>
    ...
    <section class="page-header">
      ...
      <div class="pg-tp-bg" style="background-image: url(assets/images/pg-tp-bg1.jpg);">
        <h1 class="container page-title text-white">Contact Us</h1>
      </div>
      </div>
    </section>
    <!-- Breadcrumbs Wrap -->
            ...
            <div class="row">
              <div class="col-md-8 col-sm-12 col-lg-8">
                <div class="cnt-inr" style="background-image: url(assets/images/pattern-bg2.png);">
                  ...
                  <p itemprop="description">Our friendly support team is just a phone call away. Don't hesitate to get in touch. Got something you want to discuss in writing? Shoot us an email, and we'll get back to you promptly:</p>
                  <form class="cnt-frm">
                    <div class="row mrg10">
